...
showToc: false
showSidebar: false
image: "https://screenshotit.app/https://developmentalspaces.org/what@social"
---
...
<section class="cc-wrap cc-sec" style="padding-top:0">
  ...
  <ol class="cc-list">
    ...
    <li><div class="row"><span class="n">3</span><div><div class="t">Growing up <em>· worldview development</em></div><div class="d">Progressive shifts in fundamental ways of conceiving world and self, from egocentric and ethnocentric to world-centric. Often linked to ego development and expanding circles of care.</div></div></div></li>
    <li><div class="row"><span class="n">4</span><div><div class="t">Cleaning up</div><div class="d">Healing trauma and integrating shadow material. Rooted in somatic psychology and trauma theory, processing unconscious wounds and defence mechanisms supports growth in emotional regulation and relational capacity.</div></div></div></li>
    <li><div class="row"><span class="n">5</span><div><div class="t">Showing up</div><div class="d">Deepening active, ethical engagement with the world: aligning insight and capacity with skilful action for positive change. Requires relational intelligence, moral imagination and courage.</div></div></div></li>
  </ol>
  <div class="cc-col" style="margin-top:1.5rem"><p>While separable for the sake of clarity, the domains are deeply interdependent. Development in one often supports growth in others: cognitive insight aiding shadow work, or spiritual insight enhancing ethical care.</p></div>
  <div class="cc-two" style="margin-top:2.5rem">
    <div class="cc-col"><p class="cc-cap">A caution about hierarchies</p><p style="margin-top:.5rem">Not all domains are clearly hierarchical; some, like awakening, may involve lateral shifts. The “growth-to-goodness” fallacy warns against assuming moral superiority from advanced development. Stage models are useful but must be held lightly, especially across cultures.</p></div>
    <div class="cc-col"><p class="cc-cap">Maps and rafts</p><p style="margin-top:.5rem">Within a domain, maps help orient us (Spiral Dynamics, phases of awakening). Rafts are the practices that support inner shifts (meditation, shadow work, community dialogue).</p></div>
  </div>
</section>
...
<section class="cc-wrap cc-sec" style="padding-top:0">
  ...
  <p class="cc-cap" style="margin-top:1.25rem">From the whitepaper, <em>Developmental Spaces: cultural incubators for a time of transformation</em> (Rosie Bell, Boaz Feldman and Rufus Pollock, 2025). <a class="cc-lnk" href="/paper">Read it in full</a>.</p>
</section>

<!-- earlier definitions -->
<section class="cc-wrap cc-sec" id="appendix">
  <h2 class="cc-display cc-h2">Earlier definitions</h2>
  <div class="cc-col" style="margin-top:1rem"><p>The whitepaper grew out of a series of working definitions from 2020, 2021 and 2024, and a preface on why we prefer centres to boundaries. They are kept as a record.</p></div>
