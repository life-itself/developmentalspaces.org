...
Knowledgebase for the course "Intro to Deliberately Developmental Spaces"

https://news.lifeitself.org/p/introduction-to-deliberately-developmental

## Library

🚧 Library and readings for the course in Zotero:
...
## Prototype course outputs

- Recordings of the 6 sessions (raw zoom recordings w/o editing) https://drive.google.com/drive/folders/1Gbv4VhEdzT9lfGR7amL1BptiEGzsdI3I

TODO: (?) decide zoom transcripts (vtt) are sufficient or if we want to run this material through otter (just upload the audio versions)

## Raw materials for prepping the course
