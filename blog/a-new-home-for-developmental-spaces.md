...
[The Learn stream](/learn) is for anyone exploring conscious community living. The centrepiece is our three free courses, which used to exist only as email sequences and are now fully readable online:

- [Conscious Coliving 101](/learn/courses/conscious-coliving-101) -- start here if you're new
- [Conscious Coliving in Action](/learn/courses/conscious-coliving-in-action) -- practical steps towards joining or starting a space
- [Transforming Conflict in Community](/learn/courses/transforming-conflict) -- for when living together gets real

Plus a [curated reading list](/learn/reading) and pointers to [real places](https://archipelago.place). A fourth course on practice psychology is in preparation.

### Build -- spaces that grow people

[The Build stream](/build) holds the concept and the craft: the [whitepaper](/paper), the [manifesto](/manifesto), the [network](/network), and design knowledge for anyone creating these spaces. New here: a [vision and strategy page](/build/vision) with talks and decks, and the [wiki](/wiki) -- some 65 working notes on developmental science, practices and maps that previously lived in a private course knowledge base. It's a garden, not a book: notes range from polished to raw.

### Fund -- land, stewardship, capital

[The Fund stream](/fund) continues Teal Estate. The most substantial new material on the whole site is here: between 2019 and 2021, together with Ian Sneath, Mark Bogues and Gavin O'Driscoll, I worked seriously on creating a real-estate fund for conscious community. It didn't launch in the end, but the thinking was extensive and much of it holds up. We've now [published the archive](/fund/archive): the full prospectus, the strategic analysis, our study of who invests in conscious community, the governance design, and a project application questionnaire that could still be useful if your project is looking for funding.
...
- Continuing to publish project fundraising updates in the [Teal Estate section of our newsletter](https://developmentalspaces.substack.com).

If you want to follow along, [the newsletter](https://developmentalspaces.substack.com) is the best way. And if any of this connects with something you're exploring, building or funding, do write: **developmentalspaces [at] lifeitself [dot] org**.
